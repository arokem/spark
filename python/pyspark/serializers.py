...
def _hijack_namedtuple():
    ...
    for n, o in six.iteritems(sys.modules["__main__"].__dict__):
...
class PickleSerializer(FramedSerializer):
    ...
    def dumps(self, obj):
        return six.moves.cPickle.dumps(obj, 2)

    def loads(self, obj):
        return six.moves.cPickle.loads(obj)
...
class AutoSerializer(FramedSerializer):
    ...
    def dumps(self, obj):
        if self._type is not None:
            return 'P' + six.moves.cPickle.dumps(obj, -1)
        try:
    ...
    def loads(self, obj):
        ...
        if _type == 'M':
            ...
            return six.moves.cPickle.loads(obj[1:])
        else:
